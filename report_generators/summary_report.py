...
class SummaryReportGenerator(BaseWorkflow[SummaryReportState]):
    def __init__(self) -> None:
        ...
        self._action_prompt_tpl = (
            ...
            올바른 출력:
            <li><strong>타워팰리스점</strong>: 증가세 (+4.0%) - 증가 원인을 분석하여 다른 매장에 확산 방안을 검토하세요.</li>
            <li><strong>신촌르메이에르점</strong>: 고성장 (+17.1%) - 핵심 성공 요인을 파악하고 베스트 프랙티스로 활용하세요.</li>
            <li><strong>역삼점</strong>: 안정적 증가 (+1.4%) - 고객 유지 전략을 강화하여 지속 성장을 유도하세요.</li>
            <li><strong>만촌힐스테이트점</strong>: 감소세 (-0.2%) - 감소 원인을 분석하고 고객 만족도 개선 방안을 마련하세요.</li>
            <li><strong>금천프라임점</strong>: 증가세 (+11.4%) - 성장 동력을 파악하고 유사 매장에 적용 가능성을 검토하세요.</li>
            <li><strong>마천파크점</strong>: 증가세 (+5.5%) - 꾸준한 성장세 유지를 위한 고객 서비스 강화 방안을 수립하세요.</li>

            [핵심 규칙]
            1. 각 매장별로 <li><strong>매장명</strong>: 현황 - 권장 액션</li> 형식 사용
            2. 증감률에 따른 액션 가이드:
               - 고성장(10%+): 성공 요인 분석 및 확산
               - 증가세(0~10%): 성장 동력 파악 및 유지
               - 감소세(0% 이하): 원인 분석 및 개선 방안 마련
            3. 구체적이고 실행 가능한 액션 제시
